...
export function PerceptronDiagram({ onTip }) {
  ...
  return (<svg viewBox={vb} style={ss} xmlns="http://www.w3.org/2000/svg">{defs}{lbl(105,10,"The Perceptron (1958)")}
    ...
    <g {...t("Learned weights: each connection has a trainable weight. If output is wrong, weights are nudged: w ← w + η(target − output)·x. This is the FIRST learning rule for a neural network.")}>{arr(45,33,80,48)}{arr(45,58,80,53)}{arr(45,83,80,58)}{lbl(63,38,"w₁",6,C.novel)}{lbl(63,62,"w₂",6,C.novel)}{lbl(63,80,"w₃",6,C.novel)}</g>
