...
export function LongctxDiagram({ onTip }) {
  ...
  return (<svg viewBox="0 0 220 130" style={{...ss,minWidth:190}} xmlns="http://www.w3.org/2000/svg">{defs}{lbl(110,10,"Long Context: 2K → 1M+")}
    <g {...t("Original: 512–2048 tokens. Limited by O(N²) memory, position encoding degradation, and lack of long-document training data.")}><rect x={10} y={24} width={30} height={12} rx={2} fill={C.dim}/>{lbl(25,33,"2K",5.5)}</g>
    <g {...t("Modern: 128K–1M+. Required solving multiple independent problems simultaneously.")}><rect x={10} y={24} width={200} height={12} rx={2} fill="none" stroke={C.novel} strokeWidth={1}/>{lbl(200,33,"1M+",5.5,C.novel)}</g>
