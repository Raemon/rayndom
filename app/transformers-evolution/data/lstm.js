export const entry = {
  ...
  problem: `RNN gradients vanished over long spans, so gated cell-state memory preserved signal across many timesteps.

The root cause is the vanishing gradient problem — during backpropagation through time, gradients are multiplied at each timestep. If those values are consistently less than 1, the gradient shrinks exponentially — after 20 steps, 0.9²⁰ ≈ 0.12; after 100 steps, effectively zero. The network simply cannot learn that a word from 50 steps ago matters now.
