...
export type Tag = { id: number, name: string, type: string, description?: string | null, parentTagId?: number | null, parentTag?: Tag | null, suggestedTagIds?: number[] | null, noAiSuggest?: boolean }
