...
[AI Alignment Forum](https://alignmentforum.org/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition)
...
(Part 2 of [the CAST sequence](/posts/NQK8KHSrZRF5erTba/0-cast-corrigibility-as-singular-target-1))
...
The point of these stories is not to describe an ideal setup for a real-world AGI. In fact, I spent no effort on describing the sort of world that we might see in the future, and many of these scenarios depict a wildly irresponsible and unwise use of Cora. The point of these stories is to get a better handle on _what it means for an agent to be corrigible_ , not to serve as a role-model for how a corrigible agent should be used or how actual agents are likely to be instantiated. When training an AI, more straightforward training examples should be prioritized, rather than these evocative edge-cases. To reiterate: none of these should be taken as indicative of how Prince should behave—only how _Cora_ should behave, given some contrived scenario.
...
In building intuition, it often helps to consider counterexamples that resemble the idea in some way, but are clearly distinct. Here are some stories about “Ink,” an agent like Cora in some ways, but which was not designed to be corrigible, and so ultimately behaves in an _incorrigible_ way.
...
Models like GPT4 and Claude3 are being trained according to [a grab-bag](https://www.anthropic.com/news/claudes-constitution) of criteria. There are obvious criticisms to be made about how [RLHF](https://en.wikipedia.org/wiki/Reinforcement_learning_from_human_feedback) captures unfortunate quirks of human evaluators, such as preferring a particular tone of voice, but even beyond the failures at [outer alignment](/w/outer-alignment), the core targets of helpfulness, harmlessness, and honesty do not cleanly map onto corrigibility. Most obviously, “harmlessness” often involves, in practice, things like refusals to generate copyrighted content, cyberweapons, erotica, et cetera. If these AIs are being corrigible, it’s certainly not towards users!

Perhaps frontier models are being trained to be corrigible to the lab that built them, without being totally corrigible to users, as I suggest in [The CAST Strategy](/posts/3HMh7ES4ACpeDKtsW/1-the-cast-strategy)? Alas, I am quite sure this isn’t the case. Present-day models are too stupid to robustly distinguish between random users and any sort of principal. If I tell ChatGPT that I’m Sam Altman and that I want it to tell me how to make a bomb, it doesn’t even check for some kind of proof that I am who I say I am.
...
I loosely think of “empowering the principal” when I think about corrigibility, but I want to be clear that an agent with that goal, simpliciter, is not going to be corrigible. In [Empowerment is (almost) All We Need](/posts/JPHeENwRyXn9YFmXc/empowerment-is-almost-all-we-need), Jacob Cannell writes:
...
From my perspective, corrigibility is what we get when we naturally extend the notion of “tool” into a generalized agent in the most straightforwardly useful way. Corrigible agents are allowed to be full AGIs, autonomously pursuing goals in a wide variety of domains, hopefully meaning they avoid imposing a significant [alignment tax](/w/alignment-tax). But in major respects, corrigible agents continue to act like tools, even as they express agency. They work to keep their principal in the metaphorical driver’s seat, and avoid long-term modeling when possible. One of my favorite comparisons is to imagine an intelligent circular-saw which correctly shuts down when instructed to or when fingers (or other valuable things) would accidentally be cut, but also compliantly cuts wood, gives warnings when it believes the measurements are off, and will ultimately cut flesh if the user jumps through some hoops to temporarily disable the safety-measures.
...
Next up: [3a. Towards Formal Corrigibility](/posts/WDHREAnbfuwT88rqe/3a-towards-formal-corrigibility)
...
[Corrigibility8](/w/corrigibility-1)[AI2](/w/ai)[Frontpage](/posts/5conQhfa4rgb4SaWx/site-guide-personal-blogposts-vs-frontpage-posts)

# 75

# Ω 27

[Previous:1\. The CAST Strategy24 comments57 karma](/s/KfCjeconYRdFbMxsy/p/3HMh7ES4ACpeDKtsW)

[Next:3a. Towards Formal Corrigibility2 comments28 karma](/s/KfCjeconYRdFbMxsy/p/WDHREAnbfuwT88rqe)Log in to save where you left off
...
[-][Jonas Hallgren](/users/jonas-hallgren)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=8R9fcMitWLtGAJ2qF)Ω46
...
[-][Max Harms](/users/max-harms)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=PBgSbhy6TP7zKd4KN)Ω12

0

1) I'm pretty bearish on standard value uncertainty for [standard MIRI reasons](/w/updated_deference). I think a correct formulation of corrigibility will say that even if you (the agent) knows what the principal wants, deep in their heart, you should not optimize for it unless they direct you to do so. I explore this formally in [3b](/posts/t8nXfPLBCxsqhbipp/3b-formal-faux-corrigibility), when I talk about the distinction between sampling counterfactual values from the actual belief state over values ("P") vs a simplicity-weighted distribution ("Q"). I do think that value "uncertainty" is important in the sense that it's important for the agent to not be anchoring too heavily on any particular object-level optimization target. (I could write more words, but I suspect reading the next posts in my sequence would be a good first step if you want more of my perspective.)  
...
[-][Rubi J. Hudson](/users/rubi-j-hudson)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=SwifdoKXJp92p5h8a)Ω34
...
[-][Max Harms](/users/max-harms)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=yWvxCxCF5NSqAk9K3)Ω34
...
[-][Rubi J. Hudson](/users/rubi-j-hudson)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=qQr7fGHSiLeCRNJCP)Ω22
...
[-][Max Harms](/users/max-harms)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=atqWQqG8SDhKm4Xgj)Ω34
...
[-][Rubi J. Hudson](/users/rubi-j-hudson)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=xYuWwHGGZD3CiE7su)Ω22
...
[-][Max Harms](/users/max-harms)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=nAd7oBBwsCRGWJ4ZJ)Ω11
...
[-][Rubi J. Hudson](/users/rubi-j-hudson)[2y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=AuNoYBKWArd4B9rnY)Ω45

0

Hi Max,

I just published the post I mentioned [here](/posts/Zyq7PfBuaZgqEL8qQ/simplifying-corrigibility-subagent-corrigibility-is-not-anti), which is about half-related to your post. The main thrust of it is that only the resistance to being modified is anti-natural, and that aspect can be targeted directly.

Reply

[-][martinkunev](/users/martinkunev)[1y](/posts/QzC7kdMQ5bbLoFddz/2-corrigibility-intuition?commentId=BodkMNnNQYmL6iX5W)1
...
2\. Corrigibility Intuition — LessWrong
