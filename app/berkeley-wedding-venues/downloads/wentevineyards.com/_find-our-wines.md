...
Looking for a bottle of Wente Vineyards wine near you? Enter your zip code in the box below and do a local search. Our Wine Finder lists retail establishments across the country that carry our wines in stores and restaurants.

You can also order from us [direct](http://www.wentevineyards.com/shop) – we can ship to 38 states, if yours isn’t listed here, try the wine finder below.

The retailers and restaurants featured on the list have recently purchased our wines, but we recommend reaching out to them directly to inquire about the current availability.
...
Join our email list to get the latest on upcoming wine releases and promotions.
