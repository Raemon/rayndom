...
![Eyes](/sites/default/files/styles/responsive_200w/public/2023-03/about_privacy-policy_marquee.jpg.webp?itok=0CLmNPCI)
...
##### Cookie Preferences Tool Browser Requirements

The Exploratorium website uses privacy management services from [TRUSTe](https://trustarc.com/) to provide a way for you to manage your cookie preferences on our site. To use our cookie preferences tool, you must enable third-party cookies in your web browser settings. This tool is compatible with the following web browser and mobile operating system versions:
...
Note: Opera (mobile & desktop) is not supported.
...
##### About Behavioral Ad Tracking

To help us target our advertising on other websites to your interests at the Exploratorium, we use a digital marketing technique called behavioral ad tracking, or ad retargeting. If your web browser is configured to allow third-party cookies and you haven't opted out of specific advertising cookies on our site, your browser will receive a targeting cookie. The cookie can be read by our ad delivery partners to target your browser with ads about the Exploratorium when you visit other websites. This advertising method enables us to remind you about what we have to offer and is in effect for thirty days from the time you visit our site and accept this type of cookie, or for thirty days from when you revisit our site and have previously accepted this type of cookie.

You can opt-out of advertising cookies used by our site, including those used for behavioral ad tracking and retargeting, by customizing your cookie preferences using our Cookie Preferences controls. You can also configure your web browser to block third-party cookies or install web browser extension programs, which block trackers and third-party cookies, though doing so can have an impact on some site features. If you block retargeting cookies, it doesn't mean that you won't see ads from the Exploratorium when you visit other sites; it means that the ads you see about the Exploratorium won't be targeted to you based on information gathered about your browsing behavior.

###### Learn More About Behavioral Ad Tracking

  * [Advertising Industry Resources](http://www.aboutads.info/consumers)
...
San Francisco, CA 94111-1456  
 ...
 _Set Your Advertising Cookie Preferences_
