...
![Police Officer on a bike, Firefighters battling grass fire, Lifeguard in pool with kids](/sites/default/files/styles/short_hero_800_x_686_/public/PublicSafetyHero.png?h=618f8687&itok=FbuWuUwS)

# Park Watch Report Form

  * [Police](/public-safety/police)
  * [Fire](/public-safety/fire)
  * [Lifeguard](/public-safety/lifeguard)
  * [Alerts & Closures](/alerts-closures)
  * [Fire Warning Info](/public-safety/fire/fire-warning-info)
  * [Report Incident](/public-safety/incident)
  * [Rules & Regulations](/public-safety/ordinance-38)
...
**REPORT EMERGENCIES:**  
**To report suspicious activity or an emergency which requires immediate attention, dial 911.**

**THIS FORM IS FOR NON-EMERGENCY INCIDENTS OR ACTIVITY**

Park rule violations such as reckless bike, skate or scooter riding, failure to properly leash or control pets, and improper trail usage such as mountain biking on restricted trails are examples of situations we want to know about. Unless there is an immediate danger (which should be reported as an emergency), we would like to know about the problem through the Park Watch Report (PWR). More information on [reporting park rule violations](/public-safety/incident).

**NOTE:** Anyone involved in a dog bite or any incident resulting in injury is required to exchange information with other involved parties and report it to Police and Fire Dispatch at [**(510) 881-1121**](tel:1-510-881-1121).

**TRAIL HAZARDS AND DAMAGE:** To report non-emergency safety hazards, or damaged trails and facilities, talk to a park ranger or call Public Safety Dispatch at [(510) 881-1833](tel:1-510- 881-1833). Be sure to mention the nature and exact location of the problem including the trail or area name.

[ Rules and Regulations: Ordinance 38 ](/public-safety/ordinance-38)

## Occurrence Information

The following information is requested to help District staff better provide solutions to the problem being reported. You should not feel required to fill out each field but are encouraged to enter known information. All reports will be evaluated to determine a further course that best suits the issue being reported.

Basic Info

* * *

Park or Trail Names (required)

Date of occurrence (required)

Time of occurrence (required)

Precise Location (e.g. trail name, picnic area, campsite # etc.)
...
If there was more than one person, please provide additional details:
...
Moustache, Goatee or Other

Beard (Full, Long, Short, Partial, Other Details) 
...
Year (or Approximate Year Range)

Make, Model, Body Style (2-Door, 4-Door, Covertible, Truck, Etc.) 
...
Length and type (if vessel) Other

Animal: Description

* * *

Breed or type Color(s) / Marking(s)

Optional Information (In case we have questions)
...
Describe the violation or incident
