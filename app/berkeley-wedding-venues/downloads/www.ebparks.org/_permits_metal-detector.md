...
![metal detector crown beach Jacob-Drueckhammer 2025-04](/sites/default/files/styles/short_hero_800_x_686_/public/metal-detector-crown-beach-Jacob-Drueckhammer-2025-04.jpg?h=bad0d97c&itok=sGlaeWy3)

# Metal Detector Permit

__Back to top

**A permit is required to use a metal detector in the Regional Parks**

The permit is $20 and is valid for 2 years from the date of purchase.

Metal detecting in the District is limited to beach areas, lawns and other developed park areas. Metal detecting is NOT allowed at Contra Loma Regional Park or in natural parkland areas, wilderness areas, or regional preserves.

Section 485 of the Penal Code requires that all finders of items of value must turn such items over to the appropriate police department. When such items are found within the District, you must turn the item over to the Park Supervisor or a Public Safety Officer.

There are other restrictions. For more information, and to obtain a permit, please call the Reservations Department at 1-888-327-2757, option 2.

You can also obtain a permit online:

  1. Create an account online at [EBParks.org/Register](https://apm.activecommunities.com/ebparks/Create_Account) (or login to your existing account)
  2. Purchase [Metal Detector permit](https://apm.activecommunities.com/ebparks/Membership?package_id=3).
