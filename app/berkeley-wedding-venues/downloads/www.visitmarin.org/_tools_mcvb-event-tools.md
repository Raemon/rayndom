...
[Submit A Marin Event](https://www.visitmarin.org/tools/mcvb-event-tools/submit-a-marin-event/)

Event submission at VisitMarin.org is now available! 

Submitting events requires activie membership and a login.  
For access to submit events directly, contact [gina@visitmarin.org](mailto:gina@visitmarin.org) with the following:  
Your name, name of organization, email address and phone number.

Please visit the [Marin Event Calendar](https://www.visitmarin.org/event-calendar/) to view current & upcoming events.

Next: [Accessibility Policy](/accessibility-policy/) »

« Previous: [Weekdays](/tools/weekdays/)
