[ ![Palm Event Center](/images/portal/global/palm-logo.png) ](/)
...
© 2026 | [Client Portal](/account/login/)
...
If electing to use an ACH payment method, Client acknowledges that it is their responsibility to ensure their bank account is configured and authorized to process ACH payments. Once an ACH payment is rejected that account may no longer be used for ACH payment. Beets Hospitality Group may delete this payment method from your customer wallet. Any fees associated with insufficient funds or a failed payment are the Client(s)’ responsibility, unless under the circumstance where a follow-up payment is made via personal check or cash in which the fee will be waived. 
