  ...
  return (
    <main className="min-h-screen bg-[#fffff8] px-3 pt-[10px] pb-3 font-[Georgia,serif] text-[#1f1f1f]">
      <div className="max-w-[1500px] mt-[36px] pb-[36px] mb-[36px] mx-auto text-center border-b-2 border-b-[#3f3f3f]">
        <h1 className="m-0 uppercase text-[42px] mb-3 leading-[0.95] font-medium tracking-[0.5px]">LessWrong</h1>
        <h3 className="m-0 text-[14px] uppercase leading-[1.25] font-medium tracking-[0.5px]">Refining the art of human rationality.</h3>
      </div>
