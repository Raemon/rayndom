...
Then, think to yourself (but do not say) 10 useful facts I might want to know that are relevant to my goals, that are non-obvious, non-101 level. Then say the fact you think is most useful. If you cannot find any useful facts that are not obvious, say "No useful facts found". If it looks like I solved the problem that the fact was meant to help with, say "No useful facts found".
