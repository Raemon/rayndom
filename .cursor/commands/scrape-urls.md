...
3. Start download script in BACKGROUND: python tools/download_url.py <topic> <url1> <url2> ... (use is_background=true)
...
5. If new URLs are found and relevant, start another background instance: python tools/download_url.py <topic> <url3> <url4> ...
